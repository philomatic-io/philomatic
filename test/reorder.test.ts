...
import { applyPlan, invert, isEmpty, planAdd, planMove, planPlace, planRemove, planUntieConcept, type Plan } from '../ui/src/lib/reorder';
...
describe('planUntieConcept — the × inside a tie chip (owner design 2026-07-23)', () => {
  ...
  // OWNER RULING 2026-07-23, after being asked explicitly: the trigger is SOURCE-side.
