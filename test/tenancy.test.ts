/**
 * Tenancy prep — the engine stays tenancy-free; learners are data:
 ...
 *     all-learners fold (the single-tenant view, unchanged)
 *   - the server resolves "who is acting" at ONE seam (body > ?learner= > instance > default)
 *   - rekeyLearner is the pure migration: lnr_default graphs move to real ids, never merging
 */
