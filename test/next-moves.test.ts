/**
 * nextMoves — the next-reading moves (owner design, 2026-07-24), driven by explicit source
...
// Two topics: C1 and C2, each its own owner-main (no prereq between them → distinct topics).
const asm = {
  version: 2,
