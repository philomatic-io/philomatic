...
/**
 * The snippet-markdown contract: captured text carries a CLOSED
...
describe('SnippetText', () => {
  it('renders the whole contract subset', () => {
    ...
    // Math typesets through KaTeX; raw TeX stays in the title attr.
  ...
  it('KaTeX types digits upright: the "2" is not inside an italic identifier span', () => {
    ...
    // whole point of adopting it (bare CSS italicised the numbers too).
