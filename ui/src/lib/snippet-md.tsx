...
/**
 * The snippet-markdown contract: captured snippet text may carry
 ...
 * adapter) — and every ui surface renders it through THIS component. A closed
 ...
 * and image srcs are scheme-checked). Math typesets through KaTeX (
...
function imageNode(alt: string, url: string, mode: ImageMode, key: string): ReactNode {
  ...
  // Click any rendered image → native fullscreen. stopPropagation
