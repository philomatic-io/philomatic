/**
 * The sentiment vocabulary — DECLARED by the core framework (the framework file owns overlay
 * metadata vocabularies; `ui/src/generated/framework.ts` is its baked copy), with
 * icons mapped here (icons are presentation, not vocabulary). The ENGINE stays agnostic
 * (sentiment is a free string, DATA_MODEL); unknown/legacy values display verbatim, no icon.
 */
