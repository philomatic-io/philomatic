...
/** Include a concept in the track (owner request, 2026-07-20) — the concept counterpart of the
 *  source palette (owner, 2026-07-23): the same purple box, opening into concept boxes with the
