...
/** Add sources to a track (owner ruling, 2026-07-18: Journey's drag stays experimental —
 *  membership is managed HERE). A purple picker that opens into the source palette; multiselect
 *  (owner, 2026-07-24) — check several, add them all at once. They join unordered, at the
 *  bottom. */
export function AddMemberRow({
   ...
   *  a physical book (owner ruling, 2026-07-24: url-less sources are first-class, questions tie to
...
/** The mirror of AddMemberRow, on a SOURCE's page (owner request, 2026-07-23): put THIS source
...
export function AddToTrackRow({
  ...
  return <PickerBox options={options} placeholder="add this source to a track…" variant="track" onPick={onAdd} />;
}
