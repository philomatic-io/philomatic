...
const IDENTITY_FIELDS: Record<EditKind, ReadonlyArray<string>> = {
  ...
  // track pattern; owner ruling 2026-07-24) — mint the new id, re-point edges, retract the old.
  concept: [],
...
export function update(ctx: CommandCtx, input: unknown): EditResult {
  ...
  switch (kind) {
    ...
    case 'concept': {
      ...
      // Rename-by-supersession (owner ruling, 2026-07-24): the name slugs the id, so a name
