/**
 * The edge-taxonomy of record, annotated for humans — generated views of
...
const VERB_SENTENCES: Record<EventVerb, string> = {
  STAGED: 'When it was proposed or parked — pending your validation.',
  ...
  UNSTAGED: 'You un-parked it without a verdict — the staged marker simply came off.',
  ACCEPTED: 'You accepted a proposal — it became an ordinary part of your graph.',
  REJECTED: 'You rejected a proposal — it was retracted, and the verdict kept as signal.',
...
export function taxonomyMermaid(): string {
  ...
  // dashed so the diagram stops implying snippets float free of their source.
