/**
 * The v1→v2 payload migration — ONE pure function applied
 ...
 *   1. **Id re-key** — v1 source ids hashed `url|author`; v2 pins author to ''. Only
 ...
 *   2. **Edge collapse** — retired types rewrite to LINK/ABOUT/INCLUDES + injected tags,
...
/**
 * Legacy-key normalization: every payload ever exported before the
