/**
 * Deterministic id derivation (DATA_MODEL.md).
 *
...
// and node:crypto was the frozen core's ONE node binding above the storage tier.
...
/**
 * Canonical URL normalization: used both to compute a
...
/**
 * Snippet id: a deterministic hash of the owning source
...
/**
 * Question id: a hash of the normalized question text,
