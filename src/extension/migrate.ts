...
/**
 * Legacy self-contained data hand-off. Older installs kept the whole library payload in
 * chrome.storage.local (the extension once embedded its own engine). This module owns
